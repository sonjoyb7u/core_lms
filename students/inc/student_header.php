<?php include_once("student_head.php"); ?>
...
<div class="wrap">
        ...
        <div class="rightside-header">
            ...
            <div class="header-section" id="user-headerbox">
                <div class="user-header-wrap">
                    ...
                    <div class="user-info">
                        <span class="user-name"><?= isset($_SESSION['student_login']) ? $_SESSION['student_login']:'' ?></span>
    ...
    <div class="page-body">
        <!-- LEFT SIDEBAR -->
        <!-- ========================================================= -->
        <?php include_once("student_left_sidebar.php"); ?>